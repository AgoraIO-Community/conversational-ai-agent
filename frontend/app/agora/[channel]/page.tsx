...
import { LiveAudioVisualizer } from "@/components/react-audio-visualize";
	...
	useEffect(() => {
		...
		const init = async () => {
			try {
				...
				localMediaStream.addTrack(microphoneTrack.getMediaStreamTrack());
				const mediaRecorder = new MediaRecorder(localMediaStream);
				mediaRecorder.start();
				setMediaRecorder(mediaRecorder);
				console.log("Tracks published successfully", mediaRecorder);
